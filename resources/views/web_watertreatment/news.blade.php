...
<body>
    ...
    <div class="container-fluid py-5">
        <div class="container ctn">
            ...
            @foreach ($categ_news as $c)
                <div class="container ctn">
                    <div class="row">
                        <div class="col col-sm-12 col-md-6 col-lg-4 col-xl-2">
                            <a href="{{ url('web_watertreatment/news-detail/news-id=' . $c->news_id) }}"
                                class="card col col-sm-12 col-md-6 col-lg-4 col-xl-2">
                                <img src="{{ url('images/' . $c->news_image) }}" class="card__img">
                                <span class="card__footer">
                                    <span>{{ $c->news_News }}</span>
                                </span>
