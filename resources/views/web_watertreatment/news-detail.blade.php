...
<body>
    ...
    <div class="container-fluid py-5">
        <div class="container">
            <h3><strong class="slt_title">{{$newsdetail->news_title}}</strong></h3>
            <hr>
            <br>
            {!! $newsdetail->news_News !!}
            <br><br><br><br><br><br><br>
            Thẻ: {{ $newsdetail->news_tag }}
            <hr>
            <br>
            <p>Thời gian tạo: {{ $newsdetail->created_at }}</p>
            <p>Thời gian cập nhật: {{ $newsdetail->updated_at }}</p>
        </div>
    </div>
